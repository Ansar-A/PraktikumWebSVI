			...
			<div class="col-md-12">
				<div class="card card-gray">
					<div class="card-header">
						<h3 class="card-title">FORM <small>Input Data Pegawai</h3>
					</div>
					<form method="POST" action="/pegawai" role="form" id="quickForm" enctype="multipart/form-data">
						@csrf
						<div class=" card-body">
							<div class="form-group">
								<label for="nip">NIP</label>
								<input type="text" class="form-control" id="nip" name="nip" data-inputmask='"mask": "999999999999999999"' nip-mask placeholder="Enter NIP">
							</div>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="ttglahir" name="ttglahir" placeholder="Enter Tanggal Lahir">
							</div>
							<div class="form-group">
								<label for="agama">Agama</label>
								<select type="text" class="form-control" id="agama" name="agama" placeholder="Enter Agama">
							...
							<select type="text" class="form-control" id="jkelamin" name="jkelamin" placeholder="Enter Jenis Kelamin">
